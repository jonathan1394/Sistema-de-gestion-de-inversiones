...
def render() -> None:
    ...
    if rankings:
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "Señales": st.column_config.NumColumn("Señales", width="small"),
            },
        )
    else:
    ...
    if not executable_prospects:
        ...
        if selected_prospect:
            ...
            decision = decisions.get(selected_prospect.symbol)
            suggested_amount = decision.suggested_amount_usdt if decision else 50.0
                ...
                if amount_input <= 0:
                    ...
                    if updated_decision.approved and updated_decision.action == "PAPER_BUY":
                        ...
                        try:
                            ...
                            price = _get_current_price(conn, selected_prospect.symbol)
